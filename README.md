...
> Покращений MVP для **GC Barbershop** (Барбершоп) на основі [Universal Service Template](https://github.com/Mykhailo-Zhuk/universal-service-template).

**Оригінальний сайт:** https://gentlemensclub.com.ua/
**Дев:** `npm run dev` → http://localhost:3000

## 🎯 Що змінено порівняно з оригіналом

✅ Онлайн-запис на 9 видів послуг
✅ Каталог стрижок, борід, Royal Shave
✅ Картки майстрів
✅ Адмін-панель для мульти-філії
✅ Темна/світла тема
✅ Mobile-first
...
- **Назва:** GC Barbershop
- **Категорія:** Барбершоп
- **Телефон:** +38 (068) 917-04-91
- **Додатковий:** +38 (044) 334-46-85
- **Адреса:** Київ, просп. П. Григоренка, 22/20
- **Графік:** Щодня 10:00-21:00
