/**
 * GC Barbershop (Gentlemen's Club) — налаштування бізнесу
...
const STORE: Settings = {
  restaurantName: "GC Barbershop (Gentlemen's Club)",
  address: "Київ, проспект П. Григоренка, 22/20",
  phone: "+38 (068) 917-04-91",
  email: "kyiv@gentlemensclub.com.ua",
  currency: "UAH",
  workingHours: {
    mon: { open: true, from: "10:00", to: "21:00" },
    tue: { open: true, from: "10:00", to: "21:00" },
    wed: { open: true, from: "10:00", to: "21:00" },
    thu: { open: true, from: "10:00", to: "21:00" },
